 ...
 *
 *isValidPick()
 * validates players pick
 * generatePick()
 * generates computers pick
 * isComputerWin()
 * declares a winner
 */
public class RPSLSpock {
    ...
    /**
     * isValidPick()
     *@param pick - player input for the game.
     * @return boolean: compares the player input with valid inputs
     */
    ...
    /**
     * generatePick()
     * Picks a number between 0 - 5 for the computers pick and assigns a string.
     * @return string: the string of the computers pick.
     */
     ...
     * @param h_pick - The players pick.
     * @return boolean: returns if the computer won or not.
     */
